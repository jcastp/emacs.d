  ...
  (use-package dirvish
    ...
    (dirvish-quick-access-entries ; It's a custom option, `setq' won't work
     '(("h" "~/"                          "Home")
       ...
       ("j" "~/Nextcloud_claro/gocryptfs_claro/"                "Nextcloud claro")
    ...
    ;; what files we don't want to preview
    (setq dirvish-preview-disabled-exts
  	'("iso" "bin" "exe" "gpg" "elc" "eln"
  	  ;; office files
  	  "ods" "odt" "ott" "odg" "fodg" "fods" "xlsx" "xls"
  	  ))
    ;; See how the icons and display options work
    ...
    ;; file type group arrangement - not working well
...
** TODO delete after selecting a text area
...
#+begin_src emacs-lisp
  ...
  ;; all my theme related keybindings
  ...
  (defvar-keymap my/key-prefix-map
    ...
    "q" (cons "direct access" my/key-prefix-direct-access-map)
    "u" #'consult-outline
    "r" #'recentf
    "t" (cons "themes" my/key-prefix-themes-map)
...
#+begin_src emacs-lisp
  ;; load ellama only if in my home environment
  (if my-homeenvironment-p
      (use-package ellama
        :ensure t
        :init
        ...
        (setopt ellama-providers
  		...
  		("llama3.1:latest" . (make-llm-ollama
