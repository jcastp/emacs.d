...
#+begin_src emacs-lisp
    ...
    ;;    ;;((t (:family "Lexend" :height 140 :weight Regular)))
    ;;    ((t (:family ,my-variable-font :height 140 :weight Regular)))
  ...
  (custom-theme-set-faces
   ...
   `(fixed-pitch
     ((t (:family ,my-fixed-font :height 110 :weight Medium))))

   `(default
     ((t (:family ,my-default-font :height 120 :weight Light)))))
