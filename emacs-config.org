...
I will try to document and compartmentalize the sections, so it's easier to follow up, but it won't always be possible.
...
:LOGBOOK:
- State "CANCELED"   from              [2024-04-07 dom 18:45]
:END:
  ...
  (use-package ellama
    ...
    (setopt ellama-providers
  	  '(("zephyr" . (make-llm-ollama
  	    ...
  	    ("notux - mixture experts" . (make-llm-ollama
  					  :chat-model "notux"
  					  :embedding-model "notux"))
  	    ("nous-hermes2 - code" . (make-llm-ollama
  				      :chat-model "nous-hermes2"
  				      :embedding-model "noes-hermes2"))
  	    ("dolphin_mixtral" . (make-llm-ollama
    				  :chat-model "dolphin_mixtral"
    				  :embedding-model "dolphin_mixtral"))
...
** TODO emacs activities.el
https://github.com/alphapapa/activities.el

 #+begin_src emacs-lisp
   (use-package activities
     :straight (activities :type git :host github :repo "alphapapa/activities.el")
     :straight t
     :init
     (activities-mode)
...
Adding a small menu with all the keybindings as a reference. Very useful.
...
#+begin_src emacs-lisp
  ...
  (defvar-keymap my/key-prefix-activities-map
    :doc "Functions related to activities"
    "n" #'activities-new
    "d" #'activities-define
    "r" #'activities-resume
    "z" #'activities-suspend
    "k" #'activities-kill
    "s" #'activities-switch
  ...
  (defvar-keymap my/key-prefix-map
    ...
    "a" (cons "activities" my/key-prefix-activities-map)
