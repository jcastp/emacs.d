...
** treemacs
I use this to emulate the scrivener binder feature, showing a lateral bar with all the relevant files for a novel.
...
#+end_src
** CANCELED freeze-it - kill your inner editor
