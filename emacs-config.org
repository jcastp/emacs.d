...
** Count words in orgmode, excluding comments, drawers, and properties
...
#+begin_src emacs-lisp
  ;; (load-file "./elisp/org-context-extended.el")
...
Loading my new implementation. This depends on the =org-context-extended.el=  file. Pending to convert this into a singular unit.

#+begin_src emacs-lisp
  ;; (load-file "./elisp/org-tracktable.el")
  (use-package org-tracktable
