...
#+begin_src emacs-lisp :tangle no
  ;; TODO: set my-writing-project to the real project subdirectory name before enabling
  ...
  Opens project-find-file in the novel directory and activates writing mode."
    (interactive)
