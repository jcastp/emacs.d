...
#+begin_src emacs-lisp
  ...
  (add-to-list 'org-agenda-custom-commands
     		...
     		(tags-todo "-incident-detection-automation-emailsec-edr-ai-organization-management"
  ...
  (add-to-list 'org-agenda-custom-commands
     		...
     		(tags-todo "-incident-detection-automation-emailsec-edr-ai-organization-okr-management"
...
#+begin_src emacs-lisp
  ...
  (setq org-super-agenda-groups
        '((:name "Overdue"        :deadline past          :order 1)
          ...
          (:name "Organization"   :tag "organization"     :order 35)
