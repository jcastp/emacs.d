...
#+begin_src emacs-lisp
  (fontaine-set-preset 'aporetic-sans-mono)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-files '("~/Nextcloud/trabajo/agenda/work.org"
                           )
  )
#+end_src
...
#+begin_src emacs-lisp
    (setq org-refile-targets '(
  			    ...
  			    ("~/Nextcloud/trabajo/agenda/work_backlog.org" :maxlevel . 9)
                              )
    )
...
(setq org-tag-alist '(
                      ...
                      ("detection" . ?d) ("automation" . ?a) ("emailsec" . ?e) ("operations" . ?o)
                      ;; other tags
...
#+begin_src emacs-lisp
  (setq org-capture-templates'(
                               ...
                               ("t" "Tasks (work)" entry
                                (file+headline "~/Nextcloud/trabajo/agenda/work.org" "Inbox")
                                "** TODO %? %^g \n")

                               ("i" "New incident." entry
                                (file+headline "~/Nextcloud/trabajo/agenda/work.org" "Incidents")
                                "** TODO %?")

                               ("b" "Backlog entry." entry
                                (file+headline "~/Nextcloud/trabajo/agenda/work_backlog.org" "Backlog")
                                "** TODO %?\n")

  			     ;; For meeting note taking
                               ("m" "Meeting notes" entry
                                (file+headline "~/Nextcloud/trabajo/agenda/work_meetings.org" "Meetings")
                                "** %T - %?\n"
  			      :jump-to-captured t)))
#+end_src
...
#+begin_src emacs-lisp
  (find-file "~/Nextcloud/trabajo/agenda/work.org")
#+end_src
